                        ...
                        <tbody>
                            @foreach($post as $posts)
                                <tr>
                                    ...
                                    <td>{{$posts->email}}</td>
                                    <td>
                                            <a href="{{ url('/user/reactivate/id='.$posts->id) }}" onclick="return reacForm()" type="button" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="Reactivate record">
